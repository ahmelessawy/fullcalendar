...
declare module 'fullcalendar/View' {
	...
	export abstract class Default extends InteractiveDateComponent {
	    ...
	    reportEventResizing(eventInstance: any, eventMutation: any, el: any, ev: any): void;
	    triggerEventResizing(eventInstance: any, durationDelta: any, dateProfile: any, el: any): void;
