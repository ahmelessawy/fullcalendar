...
var View = /** @class */ (function (_super) {
    ...
    View.prototype.reportEventResizing = function (eventInstance, eventMutation, el, ev) {
        var dateProfile = eventMutation.dateMutation.buildNewDateProfile(eventInstance.dateProfile, this.calendar);
        this.triggerEventResizing(eventInstance, eventMutation.dateMutation, dateProfile, el);
    };
    // Triggers event-resizing handlers that have subscribed via the API
    View.prototype.triggerEventResizing = function (eventInstance, durationDelta, dateProfile, el) {
        ...
        var dragListener = this.dragListener = new HitDragListener_1.default(component, {
            ...
            hitOver: function (hit, isOrig, origHit) {
                ...
                if (resizeMutation) {
                    ...
                    view.reportEventResizing(eventInstance, resizeMutation, el);
                }
            },
            hitOut: function () {
                resizeMutation = null;
